{
    ...
    'sequence': 1,
    'application':True,
    'depends': ['base', 'mail', 'account', 'product', 'base_automation','web', 'website'],
    'data' : [
        ...
        'views/snippets/room_snippet_edit.xml',
        'views/snippets/room_detail_template.xml',
        'views/snippets/room_website.xml',
    ],
    # 'assets': {
    #     'web.assets_frontend': [
